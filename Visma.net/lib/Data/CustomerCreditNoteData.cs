...
namespace ONIT.VismaNetApi.Lib.Data
{
    public class CustomerCreditNoteData : BasePaginatedCrudDataClass<CustomerCreditNote>
    {
        ...
        public async Task<VismaActionResult> ReleaseCreditNote(CustomerCreditNote creditNote)
        {
            return await VismaNetApiHelper.CreditNoteAction(creditNote.GetIdentificator(), "release", Authorization);
        }
